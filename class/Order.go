...
func OrderRequest(w http.ResponseWriter, r *http.Request) {
	...
	body := OrderRequestBody{ClientCode: ClientCode, OrderFor: "P", Exchange: "N", ExchangeType: "C", Price: 190, OrderID: 1, OrderType: "BUY",
		...
		ValidTillDate: "/Date(1602880914379)/", IOrderValidity: 0, OrderRequesterCode: "96131461", TradedQty: 0}
...
func OrderStatus(w http.ResponseWriter, r *http.Request) {
	...
	OrdReqList := OrdStatusReqList{Exch: "N", ExchType: "C", ScripCode: 4717, RemoteOrderID: "S123456789123456789"}
...
func TradeInformation(w http.ResponseWriter, r *http.Request) {
	...
	TradeInformList := OrdStatusReqList{Exch: "B", ExchType: "C", ScripCode: 500410, RemoteOrderID: "1557728588259000015"}
